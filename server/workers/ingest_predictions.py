...
# Keep in sync with signal_common.SIGNAL_RULES (travel categories).
    ...
    seeds = [
        {
            ...
            "description": "Seed signal for sanctions affecting travel access.",
            "probability": 0.64,
            "direction": "negative",
        ...
        },
        {
            ...
            "title": "Will the US tighten visa or border entry rules for Mexico travelers in 2026?",
            "description": "Seed signal for entry-policy change monitoring.",
            "probability": 0.42,
            "direction": "neutral",
            "affected_dimensions": ["safetyAndEntry", "accessibility"],
            "event_url": "https://polymarket.com/",
        ...
        },
        {
            ...
            "title": "Will Brazil face a major political crisis affecting travel by end of 2026?",
            "description": "Seed signal for political instability.",
            "probability": 0.38,
            "direction": "negative",
        ...
        },
        {
            ...
            "title": "Will France see sustained civil unrest disrupting tourism in 2026?",
            "description": "Seed signal for civil unrest / protests.",
            "probability": 0.45,
            "direction": "negative",
            "affected_dimensions": ["safetyAndEntry", "crowding"],
            "event_url": "https://polymarket.com/",
        ...
        },
        {
            ...
            "title": "Will another major emerging-market currency crisis hit in 2026?",
            "description": "Seed signal for traveler cost impact.",
            "probability": 0.51,
            "direction": "negative",
