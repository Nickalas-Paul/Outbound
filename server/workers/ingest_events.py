...
GDELT_QUERIES: list[tuple[str, str, str, list[str]]] = [
    ...
    (
        '"visa requirement" OR "visa ban" OR "border closure" OR "entry ban"',
        "entry_policy_change",
        "neutral",
        ["safetyAndEntry", "accessibility"],
    ),
    (
        '"political crisis" OR "coup" OR "political instability"',
        "political_instability",
        "negative",
        ["safetyAndEntry", "crowding"],
    ),
    (
        '"civil unrest" OR "mass protest" OR "general strike" OR "riots"',
        "civil_unrest",
        "negative",
        ["safetyAndEntry", "crowding"],
    ),
    ...
    (
        '"travel advisory" OR "travel warning" OR "do not travel"',
        "travel_advisory",
        "negative",
        ["safetyAndEntry"],
    ),
    (
        '"disease outbreak" OR "health emergency" OR "WHO declares"',
        "health_emergency",
        "negative",
        ["safetyAndEntry", "travelInfrastructure"],
    ),
    (
        '"extreme weather" OR "heat wave" OR "severe storm" OR "wildfire smoke"',
        "extreme_weather",
        "negative",
        ["safetyAndEntry", "travelInfrastructure"],
    ),
    (
        '"airline strike" OR "flight cancellations" OR "flights cancelled" OR "airport shutdown"',
        "airline_disruption",
        "negative",
        ["accessibility", "tourismInfrastructure"],
    ),
    (
        '"power outage" OR "transport shutdown" OR "rail shutdown" OR "port closure"',
    ...
    seeds = [
        {
            ...
            "title": "Western allies discuss economic sanctions and export controls on China",
            "description": "Seed: sanctions risk affecting travel and access.",
            "direction": "negative",
        ...
        },
        {
            ...
            "title": "US and Mexico review visa and border entry requirements",
            "description": "Seed: entry-policy change affecting cross-border travel.",
            "direction": "neutral",
            "dims": ["safetyAndEntry", "accessibility"],
        },
        {
            ...
            "title": "Political crisis in Brazil raises uncertainty for travelers",
            "description": "Seed: political instability signal for destination planning.",
            "direction": "negative",
        ...
        },
        {
            ...
            "title": "Mass protests and transport strikes disrupt travel in Europe",
            "description": "Seed: civil unrest affecting tourist crowding and safety.",
            "direction": "negative",
            "dims": ["safetyAndEntry", "crowding"],
        },
        {
            ...
            "description": "Seed: FX crisis risk for traveler costs.",
            "direction": "negative",
            "dims": ["costIndex"],
        },
        {
            ...
            "title": "Pacific earthquake and flooding disrupt regional travel infrastructure",
            "description": "Seed: natural disaster impact on travel infrastructure.",
            "direction": "negative",
        ...
        },
        {
            ...
            "title": "US State Department updates travel advisory levels for LatAm destinations",
            "description": "Seed: travel advisory level change.",
            "direction": "negative",
            "dims": ["safetyAndEntry"],
        },
        {
            ...
            "title": "Regional health authorities monitor disease outbreaks affecting tourism",
            "description": "Seed: health emergency signal for travelers.",
            "direction": "negative",
            "dims": ["safetyAndEntry", "travelInfrastructure"],
        },
        {
            ...
            "title": "Extreme heat and severe storms disrupt Iberian travel plans",
            "description": "Seed: extreme weather impact on safety and infrastructure.",
            "direction": "negative",
            "dims": ["safetyAndEntry", "travelInfrastructure"],
        },
        {
            ...
            "title": "Airline strikes and flight cancellations hit European hubs",
            "description": "Seed: airline disruption affecting accessibility.",
            "direction": "negative",
